...
const Publications = () => {
    ...
    return (
      <div className="section relative">
        ...
        <div className="container flex justify-center items-center mx-auto gap-20">
          {/* Image div */}
          ...
          {/* Heading div */}
          <motion.div variants={fadeIn('left', 0.3)} initial="hidden" whileInView={'show'} viewport={{once:false, amount: 0.3}} className='flex flex-col items-start justify-center gap-6 pt-10 '>
