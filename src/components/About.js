      ...
      <div id="about" className="section h-full">
        <div className="container flex justify-between items-center mx-auto lg:space-x-8 md:flex-row flex-col gap-16">
          ...
          <motion.div variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'}className="about-details flex flex-col items-center md:items-end justify-center  text-right gap-6 lg:gap-16 relative order-1 md:order-2">
            ...
            <h1 className="text-[30px] md:text-[40px] lg:text-[50px] xl:text-[60px] z-10 bg-gradient-to-r from-[#C0C0C0] via-[#FFFFFF] to-[#C0C0C0] bg-clip-text text-transparent leading-none font-heading">
              About Me
            </h1>
            <span className="h-1 w-[15rem] bg-gradient-to-r from-purple_light via-purple-400 to-pink-600 rounded-md"></span>
            </div>
            <p className="text-base xl:text-[18px] text-center md:text-justify z-10 leading-normal text-blue-100/60 tracking-wide">
